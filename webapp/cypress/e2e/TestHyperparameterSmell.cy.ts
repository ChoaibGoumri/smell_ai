describe('Randomness Uncontrolled Smell', () => {
  ...
  it('should complete full upload workflow and display metrics', () => {
    ...
    cy.get('input[type="file"]').selectFile('X:\\UNI\\MAGISTRALE\\ISTA\\CODESMILE\\smell_ai\\test\\system_testing\\e2e_testingCypress\\CR4.py')
    
    
    cy.contains('CR4.py').should('be.visible')
